    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} Dos strikes deferred. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def usage():
	print 'Start: python2 dos.py'
	print 'Example: dos.py http://10.7.1.50'
	print "\a"
print \
"""

__        ___     _ _       ____             _ _
\ \      / / |__ (_) |_ ___|  _ \  _____   _(_) |
 \ \ /\ / /| '_ \| | __/ _ \ | | |/ _ \ \ / / | |
  \ V  V / | | | | | ||  __/ |_| |  __/\ V /| | |
   \_/\_/  |_| |_|_|\__\___|____/ \___| \_/ |_|_|
                                 DoS V.1
